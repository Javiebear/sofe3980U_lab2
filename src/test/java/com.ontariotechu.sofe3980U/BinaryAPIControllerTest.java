...
public class BinaryAPIControllerTest {
    ...
    //new Operator Tests
    //all the test methods test if the 2 binaries hold thier expected values throughout the operation they are performing
    //this test is for when user ors the inputed values, it should equal to 1111
    @Test
    ...
    //this is testing that each value entered from the user stays consistent
	@Test
    ...
    //this test is for when user ands the inputed values, it should equal to 10
    @Test
    ...
    //this test is for when user ors the inputed values, it should equal to 1000110
    @Test
